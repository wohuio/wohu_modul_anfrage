...
/* ============================================
   HOLOGRAPHIC DESIGN SYSTEM - COMPLETE
   Alle UI-Elemente mit Cyan/Türkis Glow Effekt
   ============================================ */

/* === GLOBALE VARIABLEN === */
:root {
  --holo-primary: #0ff;
  --holo-secondary: #00ffff;
  --holo-glow: rgba(0, 255, 255, 0.6);
  --holo-border: rgba(0, 255, 255, 0.3);
  --holo-bg-dark: #111;
  --holo-bg-light: #1a1a1a;
